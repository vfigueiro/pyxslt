...
class TestStringProperty(TestProperties):
    ...
    def testRequired(self):
        self.assertRaises(
            xslt.exceptions.AttributeRequired,
            stringProperty,
            self.root,
            'str1',
            required=True,
...
class TestFloatProperty(TestProperties):
    ...
    def testInvalid(self):
        self.assertRaises(
            xslt.exceptions.InvalidAttribute, floatProperty, self.root, 'str'
        )
...
class TestBoolProperty(TestProperties):
    ...
    def testInvalid(self):
        self.assertRaises(
            xslt.exceptions.InvalidAttribute, boolProperty, self.root, 'str'
        )
...
class TestQNameProperty(TestProperties):
    def testSimple(self):
        self.assertEquals(
            qnameProperty(self.root, 'qname', namespaces={'h': 'uri:test'}),
            ('uri:test', 'b'),
        )
    ...
    def testInvalid(self):
        self.assertRaises(
            xslt.exceptions.InvalidAttribute, qnameProperty, self.root, 'float'
        )
        self.assertRaises(
            xslt.exceptions.NamespaceNotFound, qnameProperty, self.root, 'qname'
        )
...
class TestQNameListProperty(TestProperties):
    def testSimple(self):
        self.assertEquals(
            qnameListProperty(self.root, 'qnameList', namespaces={'h': 'uri:test'}),
    ...
    def testAbsent(self):
        ...
        self.assertEquals(
            qnameListProperty(self.root, 'qname0', default=' a '), [(None, 'a')]
        )

    def testInvalid(self):
        self.assertRaises(
            xslt.exceptions.InvalidAttribute, qnameListProperty, self.root, 'float'
        )
        self.assertRaises(
            xslt.exceptions.NamespaceNotFound, qnameListProperty, self.root, 'qnameList'
        )
...
class TestNameTestListProperty(TestProperties):
    def testSimple(self):
        self.assertEquals(
            nameTestListProperty(
                self.root, 'nametestList', namespaces={'h': 'uri:test'}
            ),
    ...
    def testAbsent(self):
        ...
        self.assertEquals(
            nameTestListProperty(self.root, 'nametestList0', default=' a '),
            [(None, 'a')],
        )

    def testInvalid(self):
        self.assertRaises(
            xslt.exceptions.InvalidAttribute, nameTestListProperty, self.root, 'float'
        )
        self.assertRaises(
            xslt.exceptions.NamespaceNotFound,
            nameTestListProperty,
            self.root,
            'nametestList',
        )
...
class TestNSPrefixProperty(TestProperties):
    def testSimple(self):
        self.assertEquals(
            nsPrefixProperty(self.root, 'nsPrefix1', namespaces={'h': 'uri:test'}),
            'uri:test',
        )
        self.assertEquals(
            nsPrefixProperty(self.root, 'nsPrefix2', namespaces={None: 'uri:test'}),
            'uri:test',
        )
    ...
    def testAbsent(self):
        ...
        self.assertEquals(
            nsPrefixProperty(
                self.root, 'nsPrefix0', default='h', namespaces={'h': 'uri:test'}
            ),
            'uri:test',
        )
    ...
    def testInvalid(self):
        self.assertRaises(
            xslt.exceptions.NamespaceNotFound, nsPrefixProperty, self.root, 'nsPrefix1'
        )
        self.assertRaises(
            xslt.exceptions.NamespaceNotFound,
            nsPrefixProperty,
...
class TestNSListProperty(TestProperties):
    def testSimple(self):
        self.assertEquals(
            nsListProperty(
                self.root, 'nsList', namespaces={'h': 'uri:test', None: 'uri:test1'}
            ),
            ['uri:test1', 'uri:test'],
        )
    ...
    def testAbsent(self):
        ...
        self.assertEquals(
            nsListProperty(
                self.root, 'nsList0', default='h', namespaces={'h': 'uri:test'}
            ),
            ['uri:test'],
        )
    ...
    def testInvalid(self):
        self.assertRaises(
            xslt.exceptions.NamespaceNotFound, nsListProperty, self.root, 'nsList'
        )
...
class TestExprProperty(TestProperties):
    ...
    def testAbsent(self):
        ...
        self.assertEquals(
            str(exprProperty(self.root, 'expr0', default='*')), 'child::*:*'
        )

    def testInvalid(self):
        self.assertRaises(
            xslt.exceptions.InvalidAttribute, exprProperty, self.root, 'nsPrefix2'
        )
...
class TestPatternProperty(TestProperties):
    def testSimple(self):
        self.assertEquals(
            str(patternProperty(self.root, 'pattern')),
    ...
    def testAbsent(self):
        ...
        self.assertEquals(
            str(patternProperty(self.root, 'pattern0', default='*')),
            '/descendant-or-self::node()/child::*:*',
        )

    def testInvalid(self):
        self.assertRaises(
            xslt.exceptions.InvalidAttribute, patternProperty, self.root, 'nsPrefix2'
        )
